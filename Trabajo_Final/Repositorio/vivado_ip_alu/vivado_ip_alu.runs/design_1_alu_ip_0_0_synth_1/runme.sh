...
HD_PWD='C:/Users/agust/MyS_Vazquez_Workspace/Trabajo_Final/Repositorio/vivado_ip_alu/vivado_ip_alu.runs/design_1_alu_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_alu_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_alu_ip_0_0.tcl
