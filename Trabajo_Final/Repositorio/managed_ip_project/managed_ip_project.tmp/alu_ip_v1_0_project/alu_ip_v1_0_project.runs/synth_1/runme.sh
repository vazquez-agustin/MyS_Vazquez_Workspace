...
HD_PWD='c:/users/agust/mys_vazquez_workspace/trabajo_final/repositorio/managed_ip_project/managed_ip_project.tmp/alu_ip_v1_0_project/alu_ip_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_ip_v1_0.tcl
